...
;
function Home() {
    // 1. FINALIZED FACTORS (from previous steps)
    // These define the scroll space reserved for each main component.
    const heroFactor = 1.05;
    const aboutFactor = 0.8;
    const projectsFactor = 0.9;
    // 2. CALCULATED OFFSETS
    const heroOffset = 0;
    const aboutOffset = heroOffset + heroFactor; // 1.05
    const projectsOffset = aboutOffset + aboutFactor; // 1.85
    // Total pages needed for scrolling through all content.
    const totalPages = projectsOffset + projectsFactor + 0.1; // 2.85
    // 3. Helper for background colors (you can replace with images/textures)
    const bg_color_1 = '#5c6c80'; // Dark/Muted background for Hero area
    const bg_color_2 = '#61dafb'; // Brighter transition color
    const bg_color_3 = '#212529'; // Darker color for Projects
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$spring$2f$parallax$2f$dist$2f$react$2d$spring_parallax$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Parallax"], {
        pages: totalPages,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$spring$2f$parallax$2f$dist$2f$react$2d$spring_parallax$2e$modern$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ParallaxLayer"], {
                offset: 0,
                speed: 0,
                factor: aboutOffset,
                style: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf160e80._.js.map